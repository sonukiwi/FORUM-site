...
$conn = mysqli_connect($serverName, $userName, $passWord, $dataBase);
 ...
 echo "Connection not formed"; 
  ...
  if($upVoted_By == "" && $downVoted_By == "") 
  {
      ...
      $sql2 = "UPDATE `comments` set `upVoted_By` = '$upVoted_By' where `comment_id` = $comment_id"; 
      ...
      <html lang="en">
        ...
        <body>
          ...
          <h4 style="color: red; text-align: center; padding: 7px;">You Have Successfully Upvoted</h4>
  ...
  {   
      ...
      if($len1 == 0 && $len2>=1)
      {
          ...
          { 
          $upVoted_By = $upVoted_By.$idToBeUsed; 
          $sql3 = "UPDATE `comments` set `upVoted_By` = '$upVoted_By' where `comment_id` = $comment_id"; 
      ...
      else if($len1>=1 && $len2==0)
      {
        ...
        if( $flag == true ) 
        { 
         $downVoted_By = $upVoted_By.'+'; 
         $downVoted_By = $downVoted_By.$idToBeUsed; 
        $sql3 = "UPDATE `comments` set `upVoted_By` = '$downVoted_By' where `comment_id` = $comment_id"; 
        $res3 = mysqli_query($conn, $sql3); 
        echo '<!doctype html>
        <html lang="en">
          <head>
      ...
      else if($len1>=1 && $len2>=1)
      {
        ...
        if($flag1 && $flag2) 
        {
            $newString = $upVoted_By.'+'; 
         $newString = $newString.$idToBeUsed; 
        $sql3 = "UPDATE `comments` set `upVoted_By` = '$newString' where `comment_id` = $comment_id"; 
        $res3 = mysqli_query($conn, $sql3); 
        echo '<!doctype html>
        <html lang="en">
          <head>
